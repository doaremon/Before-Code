 ...
 */
package com.ffbao.ui.widget.viewpagerindicator;
...
public class TabPageIndicator2 extends HorizontalScrollView implements PageIndicator
{
	...
	{
		final TabView2 tabView = new TabView2(getContext(), text.toString());
	...
	public class TabView2 extends RelativeLayout
	{
		...
		{
			super(context, null, R.attr.vpiTabPageIndicatorStyleLayout);
			inflater = LayoutInflater.from(context);
			inflater.inflate(R.layout.ffb_indicator_title, this);
