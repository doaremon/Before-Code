...
public class FT311UARTInterface
{
			...
			byte parity, byte flowControl)
	{
		...
		SendPacket((int)8);
		System.out.println("SetConfig   baud="+baud);
		System.out.println("SetConfig   dataBits="+dataBits);
		System.out.println("SetConfig   stopBits="+stopBits);
		System.out.println("SetConfig   parity="+parity);
		System.out.println("SetConfig   flowControl="+flowControl);
	}
